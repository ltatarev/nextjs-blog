...
export function RightArrow({
  ...
  return (
    <svg
      className="fill-purple-800 group-hover:stroke-white"
      height={24}
      viewBox="0 0 24 24"
      width={24}
